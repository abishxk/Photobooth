      ...
      <div className="relative flex items-center justify-center w-full select-none">
        ...
        >
          ...
          >
            ...
            {/* Floor shadow */}
            <ellipse cx="170" cy="427" rx="32" ry="4" fill="#000000" opacity="0.6" />

            {/* Wooden legs */}
            <rect x="144" y="346" width="8" height="80" rx="1" fill="url(#trimWood)" filter="url(#woodTexture)" />
            <rect x="188" y="346" width="8" height="80" rx="1" fill="url(#trimWood)" filter="url(#woodTexture)" />

            {/* Cross-stretcher lower support bar */}
            <rect x="144" y="398" width="52" height="6" rx="1" fill="url(#trimWood)" filter="url(#woodTexture)" />
            <circle cx="148" cy="401" r="1.2" fill="#1A0A04" />
            <circle cx="192" cy="401" r="1.2" fill="#1A0A04" />

            {/* Under-seat apron frame */}
            <rect x="141" y="344" width="58" height="10" fill="url(#trimWood)" filter="url(#woodTexture)" />

            {/* Wooden seat plank */}
            <rect x="136" y="332" width="68" height="13" rx="3" fill="url(#lightWood)" filter="url(#woodTexture)" />
            <rect x="136" y="332" width="68" height="13" rx="3" fill="none" stroke="#2E160A" strokeWidth="1.2" />
            <rect x="138" y="333" width="64" height="2" rx="1" fill="#D99E45" opacity="0.45" />
